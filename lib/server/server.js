...
app.get("/.well-known/acme-challenge/:code", function (req, res) {
  res.send(req.params.code + ".KY_NNECSQw1GMrXHsW-uij1aTpIesmtDVTbaktJBZss");
});

app.get("/*", function (req, res) {
  (0,
  _reactRouter.match)({ routes: _routes2.default, location: req.url }, function (error, redirectLocation, renderProps) {
    if (error) {
