...
var AppHandler = function (_React$Component) {
  ...
  _createClass(AppHandler, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.isMobile()) {
        var isMenuServiceDisplayed = false;
        $('a#servicios').hover(function () {
          $('#services-menu').removeClass('hidden');
        });
        $('a#services').hover(function () {
          $('#services-menu').removeClass('hidden');
        });

        $('div#services-menu').hover(function () {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_menu2.default, { items: _sitemap2.default.items.children, icons: _sitemap2.default.icons, location: location }),
