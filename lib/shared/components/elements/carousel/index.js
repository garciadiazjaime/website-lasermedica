...
var Carousel1 = function (_React$Component) {
  ...
  function Carousel1() {
    ...
    return _possibleConstructorReturn(this, (Carousel1.__proto__ || Object.getPrototypeOf(Carousel1)).apply(this, arguments));
  }
  ...
  _createClass(Carousel1, [{
    ...
    value: function renderControls(data, sliderID, className) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: 'left', href: '#' + sliderID, role: 'button', 'data-slide': 'prev' },
          _react2.default.createElement(
            'span',
            { className: 'sr-only' },
            'Previous'
        ...
        _react2.default.createElement(
          'a',
          { className: 'right', href: '#' + sliderID, role: 'button', 'data-slide': 'next' },
          _react2.default.createElement(
            'span',
            { className: 'sr-only' },
            'Next'
    ...
    value: function render() {
      var _props$data = this.props.data,
          sliderID = _props$data.sliderID,
          interval = _props$data.interval,
          indicators = _props$data.indicators,
          controls = _props$data.controls;
