...
var EquipoSection = function (_React$Component) {
  _inherits(EquipoSection, _React$Component);

  function EquipoSection() {
    _classCallCheck(this, EquipoSection);

    return _possibleConstructorReturn(this, (EquipoSection.__proto__ || Object.getPrototypeOf(EquipoSection)).apply(this, arguments));
  }

  _createClass(EquipoSection, [{
    key: 'render',
