...
var Location = function (_React$Component) {
  ...
  function Location() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Location.__proto__ || Object.getPrototypeOf(Location)).call.apply(_ref, [this].concat(args)));
  ...
  _createClass(Location, [{
    ...
    key: 'renderMap',
    value: function renderMap(data, texts) {
    ...
    value: function render() {
      var _props$data = this.props.data,
          ...
          locations = _props$data.locations,
          maps = _props$data.maps;
