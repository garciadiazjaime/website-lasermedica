  ...
  _createClass(ServiceInner, [{
    ...
    value: function getMenuItems(data, categoryUrl, service) {
      if (_lodash2.default.isArray(data) && data.length) {
        ...
        if (serviceData && _lodash2.default.isArray(serviceData.children) && serviceData.children.length) {
    ...
    value: function render() {
      ...
      var defaultSection = _locationUtil2.default.getLang() === 'ES' ? '/servicios' : '/services';
      var params = this.getDefaultValues(_db2.default[_locationUtil2.default.getLang()], defaultSection, category, service);
      var data = this.getData(category, params.service);
      var categoryUrl = [params.section, params.category].join('');
      var menuItems = this.getMenuItems(_db2.default[_locationUtil2.default.getLang()], categoryUrl, service);
