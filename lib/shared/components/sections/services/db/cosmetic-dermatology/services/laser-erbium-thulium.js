...
module.exports = [{
  ...
  type: 'list',
  className: '',
  items: ['Clear spots', 'Improve tone and texture', 'Improve the appearance of acne and surgical scars', 'Smooth expression lines and eliminate fine wrinkles', 'Fresher-looking skin']
