...
module.exports = [{
  ...
  text: ['Platelet-rich plasma, or PRP,  is one of the newest techniques used to repair facial tissue and assist in facial photorejuvenation. It is a highly recommended procedure being that there is no risk since the substance that is injected is the patient\'s own plasma, so there is no rejection, on the contrary, only  stimulation of cell proliferation and regeneration.', 'For best results, it can be used in conjunction with radiofrequency, intense pulsed light and other treatments that our experts can recommend at the time of evaluation.']
}, _common2.default.EN.item5, {
  type: 'list',
  className: '',
  items: ['Help repair sun damage', 'Tissue regeneration', 'Production of collagen']
