...
module.exports = [{
  ...
  type: 'list',
  className: '',
  items: ['Rejuvenation of the face, neck and hands', 'Lighten sunspots', 'Reduce scars caused by acne', 'Eliminate wrinkles and smooth lines of expression', 'Reduce enlarged pores']
}, _common2.default.EN.item7, {
  type: 'text',
  className: 'normal_break',
  text: ['In Lasermedica we have the best technical and medical equipment, this treatment is done through the emission of light beams that penetrate the skin causing microscopic lesions that regenerate the dermis and activate the collagen that tightens the skin, obtaining a more youthful and smooth appearance.', 'We invite you to come and get to know our facilities and other dermatological treatments, our experts will assist you in finding the treatment that will help you achieve excellent skin.']
