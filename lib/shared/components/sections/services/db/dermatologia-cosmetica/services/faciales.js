...
module.exports = [{
  ...
  type: 'list',
  className: '',
  items: ['Limpieza profunda de la piel.', 'Hidratación.', 'Eliminar impurezas.', 'Dar firmeza a la piel.', 'Eliminar radicales libres.', 'Mejorar la apariencia de la piel.', 'Mejorar circulación linfática en el rostro.']
}, {
  type: 'subtitle',
  className: '',
