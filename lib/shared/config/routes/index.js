...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouter.Route, { path: 'services/:category/:service', component: _inner2.default }),
    _react2.default.createElement(_reactRouter.Route, { path: 'services/:category', component: _inner2.default }),
    _react2.default.createElement(_reactRouter.Route, { path: 'contacto/:service', component: _contact2.default }),
    _react2.default.createElement(_reactRouter.Route, { path: 'contact/:service', component: _contact2.default }),
    _react2.default.createElement(_reactRouter.Route, { path: 'ubicacion/:ubicacion', component: _contact2.default }),
    _react2.default.createElement(_reactRouter.Route, { path: 'location/:ubicacion', component: _contact2.default })
  )
);