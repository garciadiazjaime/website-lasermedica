...
module.exports = [{
  ...
  text: [
    'A soft and clean skin is the result of microdermabrasion, which helps remove the outer layers of the skin, leaving it free of dead cells and thus helping cells regenerate, giving way to new skin.',
    'Microdermabrasion is a form of mechanical exfoliation that also helps the production of collagen in the skin.',
  ],
}, Common.EN.item5, {
  type: 'list',
  className: '',
  items: [
    'Remove impurities and imperfections',
    'Lighten sun spots',
    'Reduce pores',
    'Reduce wrinkles',
    'Smooth out scars',
