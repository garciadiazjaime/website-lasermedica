...
module.exports = [{
  ...
  type: 'text',
  className: '',
  text: 'Los antibióticos orales son básicos en el cuidado del acné moderado a severo, sobre todo al que resiste el tratamiento tópico y el acné que cubre largas áreas del cuerpo. Algunos de los antibióticos orales que pueden ser prescritos para tratar el acné incluyen tetraciclina, doxiciclina, eritromicina, azitromicina, minociclina y clindamicina. Otros medicamentos sistémicos que el médico podría indicar son la Isotretinoína y hormonales, dependiendo de la valoración y el criterio médico.',
}, {
  type: 'link',
